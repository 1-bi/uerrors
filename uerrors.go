...
type CodeError interface {
	 ...
	 * build err object
	 */
	BuildByMap(args map[string]interface{}) error
}
...
func (this *baseCodeError) Build(args ...string) error {
...
func (this *baseCodeError) BuildByMap(args map[string]interface{}) error {
